...
func serveModuleDependencies(ctx context.Context, client *Client) error {
	if err := client.ModuleSource(
		"github.com/frantjc/daggerverse/go@dagger-v1",
		ModuleSourceOpts{RefPin: "9eaa49457dbb0653d491f2ec89b26aa94257d41e"},
	).
		WithName("go").
		AsModule().
		Serve(ctx); err != nil {
	...
	if err := client.ModuleSource(
		"github.com/frantjc/daggerverse/kwok@dagger-v1",
		ModuleSourceOpts{RefPin: "9eaa49457dbb0653d491f2ec89b26aa94257d41e"},
	).
		WithName("kwok").
		AsModule().
	...
	if err := client.ModuleSource(
		"github.com/frantjc/daggerverse/mise@dagger-v1",
		ModuleSourceOpts{RefPin: "9eaa49457dbb0653d491f2ec89b26aa94257d41e"},
	).
		WithName("mise").
		AsModule().
	...
	if err := client.ModuleSource(
		"github.com/frantjc/daggerverse/release@dagger-v1",
		ModuleSourceOpts{RefPin: "9eaa49457dbb0653d491f2ec89b26aa94257d41e"},
	).
		WithName("release").
		AsModule().
